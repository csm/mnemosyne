...
Compares the agent's /task/answers.json against ground truth field by
field, per doc/E2E-TESTING.md: exact match for categorical answers, a
tolerance window for the 5xx-burst timestamp. Partial credit per field.
"""
import argparse
import json
...
def main() -> None:
    ...
    result = {"task": "logs-analysis", "score": 0.0, "checks": {}}
